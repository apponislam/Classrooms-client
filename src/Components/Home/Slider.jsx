            ...
            <Swiper className="mySwiper">
                <SwiperSlide>
                    <div className="w-full h-screen relative">
                        <img className="w-full object-cover h-screen" src="/sliderpicture3.webp" />
                ...
                <SwiperSlide>
                    <div className="w-full h-screen relative">
                        <img className="w-full object-cover h-screen" src="/sliderpicture1.jpg" />
                        <div className="absolute top-1/2 md:left-96 left-5 md:-translate-x-1/2 -translate-y-1/2 p-5 bg-white rounded-2xl w-80 md:w-96">
                ...
                <SwiperSlide>
                    <div className="w-full h-screen relative">
                        <img className="w-full object-cover h-screen" src="/sliderpicture2.jpg" />
                        <div className="absolute top-1/2 md:left-96 left-5 md:-translate-x-1/2 -translate-y-1/2 p-5 bg-white rounded-2xl w-80 md:w-96">
                ...
                <SwiperSlide>
                    <div className="w-full h-screen relative">
                        <img className="w-full object-cover h-screen" src="/sliderpicture4.jpg" />
                        <div className="absolute top-1/2 md:left-96 left-5 md:-translate-x-1/2 -translate-y-1/2 p-5 bg-white rounded-2xl w-80 md:w-96">
